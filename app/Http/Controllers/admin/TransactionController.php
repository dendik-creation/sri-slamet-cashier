...
class TransactionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $cashiers = User::where("role", User::ROLE_CASHIER)->get()->map(
            fn($user) => [
                "value" => $user->getKey(),
                "label" => $user->name,
            ],
    ...
    public function create()
    {
        ...
        return Inertia::render("Admin/Transaction/New", [
    ...
    public function store(Request $request)
    {
        ...
        $transaction = [
            "customer_id" => null,
            "cashier_id" => $auth->id, // Admin can act as cashier 😹
        ...
        return Inertia::location(route("admin.transactions.new"));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            return Inertia::location(
                route("admin.transactions.show", ["id" => $transaction->id]),
            );
        } catch (\Throwable $e) {
            DB::rollBack();
            return back()
    ...
    public function print(Request $request)
    {
        ...
        $transactions = Transaction::with("customer", "cashier")
            ...
            ->when($by_is_paid !== null && $by_is_paid !== "", function (
                $query,
            ) use ($by_is_paid) {
                $query->where(
                    "is_paid",
        ...
        return Inertia::render("Admin/Transaction/Print", [
            ...
            "description" =>
                "Cetak laporan transaksi jasa perbaikan berdasarkan periode dan filter",
            "transactions" => $transactions->map(function ($t) {
                return [
                    ...
                    "customer" => $t->customer
                        ...
                        : null,
                    "cashier" => $t->cashier
                        ? ["id" => $t->cashier->id, "name" => $t->cashier->name]
                        : null,
                    "order_at" => $t->order_at,
