...
class TransactionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // is paid ?
        if(isset($validated['trx']['payment']['amount']) && $validated['trx']['payment']['amount'] >= $transaction['total']){
        ...
        if($transaction['is_paid']){
            DB::table('payments')->insert([
                ...
                'amount' => $validated['trx']['payment']['amount'] ?? $transaction['total'],
                'paid_at' => now(),
                'created_at' => now(),
                'updated_at' => now(),
            ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        $validated = $request->validate([
            ...
            'trx.trx_items.*.status' => 'nullable|in:ACTIVE,REFUNDED,REPLACED,COMPLETED',
