...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        Route::prefix('app-setting')->group(function () {
            Route::get('/', [AppSettingController::class, 'index'])->name('cashier.app-setting.index');
            Route::put('/update', [AppSettingController::class, 'update'])->name('cashier.app-setting.update');
        });
    });
